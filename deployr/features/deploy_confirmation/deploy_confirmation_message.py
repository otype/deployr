...
import json
import time
from comms.messagequeue.queue_settings import DEPLOY_CONFIRMATION_ROUTING_KEY
from comms.messagequeue.queue_settings import GENAPI_DEPLOYMENT_CONFIRMATION_QUEUE
